...
import java.util.ArrayList; // Added for the media list
import java.util.Date;
import java.util.List;      // Added for the media list
...
public class Recipe {
    ...
    // NEW: Field to store cloud URLs for all images and videos
    private List<String> mediaUrls;

    public Recipe() {
        this.lastEdited = System.currentTimeMillis();
        // Initialize the list so it's never "null" when you try to add a photo later
