...
public class RecipeAdapter extends RecyclerView.Adapter<RecipeAdapter.RecipeViewHolder> {
    ...
    // Add this method to RecipeAdapter.java
...
// --- ICON LOGIC: Fix for "Looks the same" issue ---
        if (isTrashMode) {
            ...
            // Changed from BLACK to a theme-safe Gray/Blue so it's visible in Dark Mode!
            holder.imgAction.setColorFilter(Color.parseColor("#00BFFF"));
        } else {
